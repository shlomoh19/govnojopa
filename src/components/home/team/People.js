...
const DanielProgImWebp = 'https://lbefree.com/storage/casting/team/images/Danil_programmer.webp'
const LizaWebp = 'https://lbefree.com/storage/casting/team/images/Lisa_design.webp'
const DanilArtImWebp = 'https://lbefree.com/storage/casting/team/images/Danil_art.webp'
...
const People = [
  { id: 6, position: 'PARTNERSHIP MANAGER', FIO: 'SALMAN AHACHAD', webp: SalmanWebp, photo: '', video: SalmanVideo },
  { id: 4, position: 'PROGRAMMER', FIO: 'EUGENE SLUGIN', webp: EvgenyWebp, photo: EvgenyImg, video: false },
  { id: 1, position: 'PROGRAMMER', FIO: 'IVAN KHANIN', webp: IvanWebp, photo: '', video: IvanVideo },
  { id: 10, position: 'PROGRAMMER', FIO: 'DANIEL RASSOMAKHIN', webp: DanielProgImWebp, photo: '', video: DanielProgVideo },
  { id: 10, position: 'PR MANAGER', FIO: 'KRISTINA SOSIPATROVA', webp: KristinaWebp, photo: '', video: KristinaVideo },
  { id: 11, position: 'PR MANAGER', FIO: 'OLGA KORNEEVA', webp: OlgaWebp, photo: '', video: OlgaVideo },
  { id: 7, position: 'FILM DIRECTOR', FIO: 'OLGA ZVEZDOGLIAD', webp: ShkolnicaWebp, photo: '', video: ShkolnicaVideo },
  { id: 9, position: 'WEB DESIGNER', FIO: 'MARINA BIBIK', webp: MarinaWebp, photo: '', video: MarinaVideo },
  { id: 2, position: 'WEB DESIGNER', FIO: 'ELIZAVETA ZINENKO', webp: LizaWebp, photo: LizaImg, video: false },
  { id: 3, position: 'ART DESIGNER', FIO: 'DANILA MALYUTIN', webp: DanilArtImWebp, photo: '', video: DanilArtVideo },
  { id: 8, position: 'ACCOUNT MANAGER', FIO: 'IGOR LYAKHOV', webp: IgorWebp, photo: '', video: IgorVideo },
]
